...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'cost' => [
            'required' => 'Արժեք դաշտը պարտադիր է ',

            'numeric' => 'Արժեք դաշտը պետք է լինի թիվ',
        ],
        'loan_term' => [
        ...
        'loan_amount' => [
            'required' => 'Վարկի գումար դաշտը պարտադիր է ',

            'numeric' => 'Վարկի գումար դաշտը պետք է լինի թիվ',
        ],
        'gold_pledge_type' => [
            'required' => 'Գրավ դաշտը պարտադիր է ',
        ...
        'purpose_type' => [
            'required' => 'Նպատակ դաշտը պարտադիր է ',

            //'numeric' => 'Վարկի գումար դաշտը պետք է լինի թիվ',
        ],
        'transfer_amount' => [
            'required' => 'Գումար դաշտը պարտադիր է',

            'numeric' => 'Գումար դաշտը պետք է լինի թիվ',
        ],
        'travel_country' => [
            'required' => 'երկիր դաշտը պարտադիր է',

            'numeric' => 'երկիր դաշտը անվավեր է',
        ],
        'country' => [
            'required' => 'Ստացող երկիր դաշտը պարտադիր է',

            'numeric' => 'Ստացող երկիր դաշտը պետք է լինի թիվ',
        ],
        'travel_term' => [
            'required' => 'Օրերի քանակ դաշտը պարտադիր է',

            'numeric' => 'Օրերի քանակ դաշտը պետք է լինի թիվ',
        ],
        'age' => [
            'required' => 'Տարիք դաշտը պարտադիր է',

            'numeric' => 'Տարիք դաշտը պետք է լինի թիվ',
        ],
