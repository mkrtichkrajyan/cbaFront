                            ...
                            <div class="slider-item">
                                <div class="compare_name">
                                    ...
                                    <div class="servis_name">
                                        @if($product->currencyInfo->count()>0)
                                            {{$product->currencyInfo->name}}
                                        @endif
                                    </div>
                                    ...
                                    <div class="servis_name servis_name_mid">
                                        <span>{{$product->borrower_accident_insurance_fee_absolute_amount}}</span>
                                        @if(strpos($product->borrower_accident_insurance_fee_absolute_amount, "%") != false )
                                            {{$product->borrower_accident_insurance_fee_pay_from}}
                                            - {{$product->borrower_accident_insurance_fee_pay_to}}
                                        @endif
                                    </div>

                                    <div class="servis_name servis_name_mid">
                                        <span>{{$product->cadastre_related_fee}}</span>
                                    </div>
