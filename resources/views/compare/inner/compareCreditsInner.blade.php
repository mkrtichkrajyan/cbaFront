        ...
        <div class="columns large-12 medium-12 small-12">
            <div class="wrapper slider">
                <div class="compare_name_servis">
                    ...
                    <div class="compare_name_podtitle sell_salons_podtitle">
                        սրահներ
                    </div>
                    <div class="compare_name_podtitle compare_name_podtitle_mid">
                            ...
                            <div class="slider-item">
                                <div class="compare_name">
                                    ...
                                    <div class="servis_name servis_name_mid">
                                        @if($product->ProductPurposes->count() > 0)
                                            @php($productPurposeTypesArr    =   [])

                                            @foreach($product->ProductPurposes as $productCurrPurpose)
                                                @php($productPurposeTypesArr[]  =  $productCurrPurpose->purposeTypeInfo->name )
                                            @endforeach
                                    ...
                                    <div class="servis_name servis_name_large servis_name_scroll">
                                    ...
                                    <div class="servis_name servis_name_car_salons">
                                        <div class="car_salons_info_sexion">
                                            ...
                                            @if($product->salons == 1)
                                                <ul>
                                                    @foreach($product->sellSalons as $productCurrSellSalons)
                                                        <li>
                                                            <div class="car_salons_current">
                                                                <span>Անուն: {{$productCurrSellSalons->name}}</span></br>

                                                                <span>Հասցե: {{$productCurrSellSalons->address}}</span></br>

                                                                <span>Հեռախոս: {{$productCurrSellSalons->phone}}</span></br>
                                                            </div>
                                                        </li>
                                                    @endforeach
                                                </ul>
