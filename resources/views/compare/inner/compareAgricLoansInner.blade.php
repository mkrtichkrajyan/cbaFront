            ...
            <div class="wrapper slider">
                <div class="compare_name_servis">
                    <div class="compare_name_title">
                        ...
                        <span>Գյուղատնտեսական վարկեր</span>
                    </div>
                        ...
                        @foreach($compareVariationsData as $compareVariationsDataCurr)
                            ...
                            <div class="slider-item">
                                <div class="compare_name">
                                    ...
                                    <div class="servis_name servis_name_mid">
                                        <span>{{$product->pledge_state_registration_pay}}</span>
                                        @if(strpos($product->pledge_state_registration_pay, "%") != false )
                                            {{$product->pledge_state_registration_pay_from}}
                                            - {{$product->pledge_state_registration_pay_to}}
                                        @endif
                                    </div>
