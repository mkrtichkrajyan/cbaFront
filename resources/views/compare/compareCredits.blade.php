                ...
                <div class="wrapper slid-wrapper">
                    <div class="row">
                        <div class="columns large-3 medium-6 small-12">
                            <label class="label" for="car_cost">Արժեք</label>
                            <div class="rel">
                                <input type="number" min="0" name="cost"
                                       class="input no_negative_value" id="cost" value="{{$cost}}">

                                <input type="hidden" name="cost_search" id="cost_search" value="{{$cost}}">
