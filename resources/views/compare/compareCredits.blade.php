...
<main>
    ...
    <input type="hidden" value="{{url('/credit-loan-product/')}}" id="prod_page_path" name="prod_page_path"/>
    ...
    <input type="hidden" value="{{$cost}}" id="prod_cost" name="prod_cost"/>
    ...
    <form id="seachProductForm" enctype="multipart/form-data" class="form-horizontal" name="creditLoanForm"
                ...
                <div class="wrapper slid-wrapper">
                    <div class="row">
                        <div class="columns large-3 medium-6 small-12">
                            <label class="label" for="car_cost">Ապրանքի արժեք</label>
                            <div class="rel">
                                <input type="number" min="0" name="cost"
                                       class="input only_numbers more_than_zero" id="cost" value="{{$cost}}">

                                <input type="hidden" name="cost_search" class="cost_search" id="cost_search"
                                       value="{{$cost}}">
                        ...
                        <form>
                            ...
                            <div class="check-drop-down-wrapper">
                                ...
                                <div class="check-drop-down">
                                    ...
                                    @foreach ($creditPurposeTypes as $purposeType)
                            ...
                            <div class="wrapper pading">
                                ...
                                <div class="listing-title">
                                    <div class="left">
                                        ...
                                        @php($unique_options_and_search_params  =   $unique_options."*"."_cost_".$cost."_prepayment_".$prepayment."_term_".$loan_term_search_in_days)
                                        ...
                                        <a href="{{url('/credit-loan-product/'.$unique_options.'/'.$cost.'/'.$prepayment_final.'/'.$time_type.'/'.$loan_term)}}"
                                           class="btn btn-more">
                                            <span>ավելին</span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".filter_selectbox").parent().find('.select-selected').bind("DOMSubtreeModified", function () {
            ...
            filter_products("{{url('/credit-loans-filters/')}}");
        });
        ...
        $(document).on('click', '.product_variations_results_pagination a', function (e) {
            ...
            filter_products("{{url('/credit-loans-filters/')}}", page, page_by_company);
        })
    });
</script>
