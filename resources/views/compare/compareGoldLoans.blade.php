...
<link rel="stylesheet" href="{{asset('/css/products/compare/compareGoldLoans.css')}}">
...
<main>
    ...
    <input type="hidden" value="{{url('/gold-loan-product/')}}" id="prod_page_path" name="prod_page_path"/>
                        ...
                        <div class="columns large-3 medium-6 small-12">
                            ...
                            <div class="custom-select-second wrapper gold_pledge_type_selectbox">
                                <select id="gold_pledge_type" name="gold_pledge_type"
                                    ...
                                    @foreach($gold_pledge_types as $gold_pledge_type_curr)
                                        <option @if($gold_pledge_type == $gold_pledge_type_curr->id) selected @endif
                                        value="{{$gold_pledge_type_curr->id}}">{{$gold_pledge_type_curr->name}}</option>
                                    @endforeach
                                </select>
                            </div>

                            @if ($errors->has('gold_pledge_type'))
                                <span class="help-block err-field">
                                <strong>{{ $errors->first('gold_pledge_type') }}</strong>
                            </span>
                            @endif

                            <select class="displayNone" id="gold_pledge_type_search" name="gold_pledge_type_search"
                                    class="filter_product filter_gold_pledge_type">
                                <option value="">Գրավ</option>
                                @foreach($gold_pledge_types as $gold_pledge_type_curr)
                                    <option @if($gold_pledge_type == $gold_pledge_type_curr->id) selected @endif
                            ...
                            <div class="check-drop-down-wrapper">
                                ...
                                <div class="check-drop-down">
                                    ...
                                    @foreach($gold_assay_types as $gold_assay_type)
                                        <label class="container">{{$gold_assay_type["info"]->name}}
                                            <input type="checkbox" id="gold_assay_type_{{$gold_assay_type['id']}}"
                                                   data-id="{{$gold_assay_type['id']}}"
                                                   name="gold_assay_type_{{$gold_assay_type['id']}}"
                                                   value="1"
                                                   class="filter_product filter_checkbox filter_gold_assay_type">
                                            <span class="checkmark"></span>
                                            <span class="single_filter_count gold_assay_type_filter_count">{{$gold_assay_type["count"]}}</span>
                                        </label>
                                    @endforeach
                            ...
                            <div class="wrapper pading">
                                ...
                                <div class="listing-title">
                                    <div class="left">
                                        ...
                                        <a href="{{url('/gold-loan-product/'.$unique_options.'/'.$loan_amount.'/'.$time_type.'/'.$loan_term)}}"
                                           class="btn btn-more">
                                            <span>ավելին</span>
                                        ...
                                        @foreach($productsWithVariationsGroupByCompanyCurr as $productsWithVariationsGroupByCompanyCurrVariationCurr)
                                            <div class="table-wrapper">
                                                ...
                                                <div class="th flex-wrapper ">
                                                    ...
                                                    {{--@php($curr_unique_options_variation_url    =   url('/gold-loan-product/'.$unique_options.'/'.$loan_amount.'/'.$time_type.'/'.$loan_term))--}}
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".filter_selectbox").parent().find('.select-selected').bind("DOMSubtreeModified", function () {
            ...
            filter_products("{{url('/gold-loans-filters/')}}");
        });
