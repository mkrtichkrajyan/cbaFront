...
<main>
    ...
    <input type="hidden" value="{{url('/loan-refinancing-product/')}}" id="prod_page_path" name="prod_page_path"/>
                            ...
                            <div class="wrapper pading">
                                ...
                                <div class="listing-title">
                                    <div class="left">
                                        ...
                                        <a href="{{url('/loan-refinancing-product/'.$unique_options.'/'.$loan_amount.'/'.$time_type.'/'.$loan_term)}}"
                                           class="btn btn-more">
                                            <span>ավելին...</span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".filter_selectbox").parent().find('.select-selected').bind("DOMSubtreeModified", function () {
            ...
            filter_products("{{url('/loan-refinancing-filters/')}}");
        });
