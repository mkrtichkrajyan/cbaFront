...
<main>
    ...
    <input type="hidden" value="{{url('/agric-loan-product/')}}" id="prod_page_path" name="prod_page_path"/>
                ...
                <div class="wrapper slid-wrapper">
                    <div class="row">
                        ...
                        <div class="columns large-3 medium-6 small-12">
                            ...
                            <select cl id="currency_search" name="currency_search"
                                    class="filter_product filter_currency displayNone">
                                <option value="">Արժույթ</option>
                                @if(is_null($currency))
                                    @php($currency = 1)
                                @endif
                            ...
                            <div class="wrapper pading">
                                ...
                                <div class="listing-title">
                                    <div class="left">
                                        ...
                                        <a href="{{url('/agric-loan-product/'.$unique_options.'/'.$loan_amount.'/'.$time_type.'/'.$loan_term)}}"
                                           class="btn btn-more">
                                            <span>ավելին</span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".filter_selectbox").parent().find('.select-selected').bind("DOMSubtreeModified", function () {
            ...
            filter_products("{{url('/agric-loans-filters/')}}");
        });
