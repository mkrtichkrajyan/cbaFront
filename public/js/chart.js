$("document").ready(function () {
    ...
    more_payment_amount_piece = $("#more_payment_amount_piece").val();

    loan_amount_piece = $("#loan_amount_piece").val();

    // alert(loan_amount_piece);
                    ...
                    infoContainer.data([data.value * 100])
                        ...
                        .tween('text', function (d) {
                            ...
                            return function (t) {
                                ...
                                // $('.chart-count-1').text(i( t ) + ' %');
                                // $('.chart-count-2').text((100 - (i( t )*1)) + ' %');
                            };
                        });
