...
$(document).ready(function () {
    ...
    // $(".btn-pink").click(function () {
    //     console
    //     // alert($(this).parent().parent().nextAll(".hide-show").css('display'));
    ...
    //     }
    //
    //     if($(this).parent().parent().nextAll(".hide-show").css('display') == "none"){
    //         $(this).parent().parent().nextAll(".hide-show").slideDown(300);
    //     }
    //     else{
    //         // $(this).parent().parent().nextAll(".hide-show").slideUp(300);
    //     }
    //
    // });
